...
describe('utils/colorManipulator', function () {
   ...
   */
  describe('convertColorToString', function () {
    it('converts a decomposed rgb color object to a string` ', function () {
      _chai.assert.strictEqual((0, _colorManipulator.convertColorToString)({ type: 'rgb', values: [255, 255, 255] }), 'rgb(255, 255, 255)');
    });

    it('converts a decomposed rgba color object to a string` ', function () {
      _chai.assert.strictEqual((0, _colorManipulator.convertColorToString)({ type: 'rgba', values: [255, 255, 255, 0.5] }), 'rgba(255, 255, 255, 0.5)');
    });

    it('converts a decomposed hsl color object to a string` ', function () {
      _chai.assert.strictEqual((0, _colorManipulator.convertColorToString)({ type: 'hsl', values: [100, 50, 25] }), 'hsl(100, 50%, 25%)');
    });

    it('converts a decomposed hsla color object to a string` ', function () {
      _chai.assert.strictEqual((0, _colorManipulator.convertColorToString)({ type: 'hsla', values: [100, 50, 25, 0.5] }), 'hsla(100, 50%, 25%, 0.5)');
    });
  });
  ...
  describe('getContrastRatio', function () {
    it('returns a ratio of 21 for black : white', function () {
      _chai.assert.strictEqual((0, _colorManipulator.getContrastRatio)('#000', '#FFF'), 21);
    });

    it('returns a ratio of 1 for black : black', function () {
      _chai.assert.strictEqual((0, _colorManipulator.getContrastRatio)('#000', '#000'), 1);
    });

    it('returns a ratio of 1 for white : white', function () {
      _chai.assert.strictEqual((0, _colorManipulator.getContrastRatio)('#FFF', '#FFF'), 1);
    });

    it('returns a ratio of 3.92 for dark-grey : light-grey', function () {
      _chai.assert.strictEqual((0, _colorManipulator.getContrastRatio)('#707070', '#E5E5E5'), 3.93);
    });

    it('returns a ratio of 3.93 for black : light-grey', function () {
      _chai.assert.strictEqual((0, _colorManipulator.getContrastRatio)('#000', '#888'), 5.92);
    });
  });
  ...
  describe('getLuminance', function () {
    it('returns a luminance of 1 for rgb white', function () {
    ...
    it('returns a normalized luminance from an hsl color', function () {
  ...
  describe('emphasize', function () {
    ...
    it('lightens a dark rgb color with the c0efficient 0.15 by default', function () {
